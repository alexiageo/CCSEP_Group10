...
2. Then type 'make run', when terminal indicate 'Listening at: http://0.0.0.0:5000',
  open browser ,and enter 127.0.0.1:5000 to load the webpage
...
8. Append a new line 'X-Forwarded-Host: 127.0.0.1:5000/static'
